...
@SupportedAnnotationTypes("com.a.b.BuilderProperty")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@AutoService(Processor.class)
public class BuilderProcessor extends AbstractProcessor {
    private Logger log = LoggerFactory.getLogger(BuilderProcessor.class);

    @Override
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        log.info("!!!!!!BuilderProcessor process111111111111111111");
        for (TypeElement annotation : annotations) {
            System.out.println("aaaaaaaaaaaaaa" + annotation.getClass());
    ...
    private void writeBuilderFile(String className, Map<String, String> setterMap) throws IOException {
        ...
        log.info("JavaFileObject:{}", builderFile.getName());
        System.out.println("aaaaaaaaaaaaaa writeBuilderFile" + builderFile.getName());
        try (PrintWriter out = new PrintWriter(builderFile.openWriter())) {
            ...
            // out.print("import com.a.b.BuilderProperty;");
