 ...
 * 压缩
 *
 * A simple client that requests a greeting from the {@link io.grpc.examples.helloworld.HelloWorldServer}.
 *
 * This class should act a drop in replacement for {@link io.grpc.examples.helloworld.HelloWorldClient}.
 */
